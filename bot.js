...
${chalk.blue.italic('☣️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('🛡️Bot is working!')
        );
        ...
        if (config.WORKTYPE == 'public') {
            ...
            if (config.LANG == 'SI' || config.LANG == 'AZ') { 
                if (config.FULLEVA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*🧚‍♂≛  *W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎*  ≛ As private! ☣️*\n\n_මෙය ඔබගේ LOG අංකයයි..මෙහි විධාන භාවිතයෙන් වළකින්න._\n_ඔබට පුලුවන් වෙනත් ඕනෑම කතා බහක විධාන භාවිතා කිරීමට.. :)_\n\n*ඔබේ Bot Private ආකාරයට ක්‍රියා කරයි..එය වෙනස් කිරීමට* _.setvar WORK_TYPE:public_ *විධානය භාවිතා කරන්න.*\n\n*Bot ක්‍රියාත්මක වන්නෙ කෙසේද හා විධාන ලැයිස්තු ලබා ගැනීමට⚜ .basichelp විධානය භාවිතා කරන්න*\n\n≛  *W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎*  ≛ භාවිතා කිරීම සම්බන්ධයෙන් ස්තූතියි 💌*', MessageType.text);
                }
                await git.fetch();
                var commits = await git.log([config.BRANCH + '..origin/' + config.BRANCH]);
                if (commits.total === 0) {
                ...
                if (config.FULLEVA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*🧚‍♂≛  *W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎*  ≛ Working As private!☣️*\n\nPlease do not try any commands here. This is your log number._\n_You can try commands anywhere else :)_\n\n_Type_ *.basichelp* _to get your full Help list and Basic Commands._\n\n_Your bot in private  Mode. To change, use_ ```.setvar WORK_TYPE:public``` _command._\n\n*Thanks for using 🧚‍♂≛  *W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎*  ≛💌*', MessageType.text);
                }
                await git.fetch();
                var commits = await git.log([config.BRANCH + '..origin/' + config.BRANCH]);
                if (commits.total === 0) {
...
//=====================================================================================
                        ...
                        try {
                            ...
                            if (config.LANG == 'SI' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- බොට් වාර්තාව [≛  W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎  ≛] --*' + 
                                    '\n*≛  *W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎*  ≛ නිසි ලෙස ක්‍රියා කරයි!*'+
                                    ...
                                    '\n_සහය සමූහ: No Support\n\n' +
                                    '*🚫ප්‍රධාන දෝෂය:* ```' + error + '```\n\n'
                                    , MessageType.text, {detectLinks: false});

                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚜ 🙇දෝශ විශ්ලේෂනය [≛  *W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎*  ≛] ⚜*' + 
                                        '\n========== ``` 🧚‍♂දෝශ විශ්ලේෂනය!``` ==========' +
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ◁දෝශ වාර්තාව▷ [≛  *W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎*  ≛] ⚕️*' + 
                                        '\n========== ``` 🧚‍♂දෝශ විශ්ලේෂනය!``` ==========' +
                                ...
                                if (error.message.includes('URL')) {
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*🧚‍♂Sorry, I Couldnt Read This Error!🙇🏻*' +
                                        '\n_You can write to our support groups for more help.'
                                        , MessageType.text
                                    );
                               }
                          }
