...
module.exports = {
    ...
    DEVELOPER_TAG: process.env.DEVELOPE_TAG === undefined ? 'Mr.Shashiya & Dark Devil' : process.env.DEVELOPE_TAG,
    DEVELOPER_STATUS : process.env.DEVELOPER_STATUS === undefined ? 'Dev:Mr.Shashiya & Dark Devil' : process.env.DEVELOPER_STATUS,
...
A_TEENU: process.env.A_TEENU === undefined ? '' : process.env.A_TEENU,
A_TEENU: process.env.A_TEENU === undefined ? '' : process.env.A_TEENU, 
WA_CONNECTION: process.env.WA_CONNECTION === undefined ? '94768864999,0' : process.env.WA_CONNECTION,
A_TEENU: process.env.A_TEENU === undefined ? '' : process.env.A_TEENU,
    HEROKU: {
