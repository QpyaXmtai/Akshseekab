...
module.exports = {
    ...
    BIO: process.env.BIO === undefined ? 'this is Shashimal & Devils bot im not perfect this is limited edition' : process.env.BIO,
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/0633a7cae17cf25843a23.png' : process.env.ALIVE_LOGO,
    CAPTIONS: process.env.CAPTIONS === undefined ? 'Made By Mr.Shashiya & Dark Devil' : process.env.CAPTIONS,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Mr.Shashiya & Dark Devil' : process.env.BOT_NAME,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'true' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '*Downloading Song*' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? 'Uploading Song' : process.env.SONGU,
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ?'https://telegra.ph/file/0633a7cae17cf25843a23.png' : process.env.MENU_LOGO,
    ...
    PANEL_COMMAND: process.env.PANEL_COMMAND === undefined ? 'menu2' : process.env.PANEL_COMMAND,
    ...
    MENU_INFO: process.env.MENU_INFO === undefined ?'bot ɪꜱ ᴀ ᴘᴏᴡᴇʀꜰᴜʟʟ ʙᴏᴛ ꜰᴏʀ ᴡʜᴀᴛꜱᴀᴘᴘ.' : process.env.MENU_INFO,
    BRANCH: 'main',
    HEROKU: {
