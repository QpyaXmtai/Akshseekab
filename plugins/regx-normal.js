...
Neotro.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (message.jid === '919562803423-1627735504@g.us') {
         ...
         let regex1 = new RegExp('☣️ANIME-LIST')
         let regex2 = new RegExp('☣️MEME-LIST')
         let regex3 = new RegExp('☣️TTP-LIST')
         let regex4 = new RegExp('☣️ALL-COMMAND')
         let regex5 = new RegExp('☣️ADMIN-LIST')
         let regex6 = new RegExp('☣️LOGO-LIST')
         let regex7 = new RegExp('☣️DOWNLOAD-LIST')
         let regex8 = new RegExp('☣️MAIN-LIST')
         let regex9 = new RegExp('☣️HELP-LIST')
         let regex10 = new RegExp('☣️APK-LIST')
         let regex11 = new RegExp('☣️EHI-LIST')
         ...
         let regex19 = new RegExp('UASH')
          if (regex1.test(message.message)) {              
             await message.client.sendMessage(message.jid,'*≛  W͎A͎ T͎O͎O͎L ͎ K͎I͎T͎ B͎O͎T͎  ≛ Anime List*\n\n╔═════════▷\n╠🌼: .loli\n╠🌼: .wifu\n╠🌼: .neko\n╠🌼: .ava\n╠🌼: .kemo\n╠🌼: .awoo\n╠🌼: .shinobu\n╠🌼: .megumin\n╚═════════▷', MessageType.text, {quoted: message.data })
         } 
